                    ...
                    <table class="min-w-full border border-gray-200 mt-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border p-2">
                                    <input type="number" name="qty[]" value="{{ $item->order_item_quantity }}" class="form-control qty" min="1" oninput="calculateAmount(this)">
                                ...
                                <td class="border p-2"><input type="text" name="price[]" value="{{ $item->order_item_price }}" class="form-control price small-input" readonly></td>
                                <td class="border p-2"><input type="number" name="dis[]" value="{{ intval($item->order_item_discount) }}" class="form-control dis" min="0" max="100" oninput="calculateAmount(this)"></td>
                    ...
                    <div class="flex space-x-6 mt-2">
                        ...
                        <label class="inline-flex items-center">
                            <input type="radio" name="payment_type" value="E-Wallet" class="form-radio text-blue-600" 
                                {{ $order->payment->payment_type == 'E-Wallet' ? 'checked' : '' }} required>
                        ...
                        <label class="inline-flex items-center">
                            <input type="radio" name="payment_type" value="Credit/Debit Card" class="form-radio text-blue-600" 
                                {{ $order->payment->payment_type == 'Credit/Debit Card' ? 'checked' : '' }} required>
